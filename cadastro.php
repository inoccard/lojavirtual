  ...
  <body>
    <form id="cadastro" name="cadastro" method="post" action="cadastro_user.php" onsubmit="return validaCampo(); return false;">
      <table width="625" border="0">
        ...
        <tr>
          <td>Sexo:</td>
          <td><input name="sexo" type="radio" value="M" checked="checked">Masculino
            <input name="sexo" type="radio" value="F">Feminino <span class="style1">*</span> </td>
        </tr>
        <tr>
          <td>TELEFONE:</td>
          <td>
            ...
            <tr>
              <td colspan="2">
                <p>
                  ...
                  <span class="style1">* Campos com * s�o obrigat�rios! </span>
                </p>
                <p>
                  <?php
