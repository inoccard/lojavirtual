...
//tirar espaço em branco das variaveis recebidass através de formulario
  ...
  include ("../conecta.php");
$sql = "UPDATE produtos SET codigo='$campo1',id='$campo2',id_filho='$campo3',produto='$campo5',fabricante='$campo4',preco='$preco_decimal',imagem='$campo7', autorizado='$campo8' , detalhes='$campo9'
 WHERE codigo='$campo1'";
