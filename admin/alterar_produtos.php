...
$sql =mysqli_query($conexao,"SELECT * FROM $tabela WHERE codigo='$codigo'");

}
while($dados=mysqli_fetch_array ($sql)) {
$nome0 = $dados[0]; //codigo
$nome1 = $dados[1]; //artista
$nome2 = $dados[2]; //album
$nome3 = $dados[3]; //preco
$nome4 = $dados[4]; //imagem
$nome5= $dados[5];  //autorizado
$nome6= $dados[6];  //detalhes
...
<tr>
  ...
  <td><img src=\"../mini.php?imagem=$nome4\"></td>
</tr>
<tr>
  <td>AUTORIZAR</td>
